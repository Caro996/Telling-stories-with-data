...
<script type='text/javascript'>                    
  var divElement = document.getElementById('viz1664682938171');                    
  var vizElement = divElement.getElementsByTagName('object')[0];                    
 ...
 **Why Grammies are so important to artists?**
 ...
 <script type='text/javascript'>                    
  var divElement = document.getElementById('viz1664685017076');                    
  var vizElement = divElement.getElementsByTagName('object')[0];                    
...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| Q1:  Are all the storyboards clear and closely related to the main topic ?| 整体来说是的，但内容整体不仅仅是单纯描述女性占比，而是更多描述和分析女性音乐者在行业的地位和状态，目的是号召大家关注女性音乐家，因此标题本身应该更有号召性，阐述一个观点。 | 是和主题紧密相关的，但是因为内容过多，滚动浏览界面的方式切断部分与部分之间的联系，做个tab目录，直接点击到达对应部分会让结构更清晰;做网页的时候要有一个启示封面页 |  Content Cell  |  Content Cell  |
| Q2:  Is there anything you find surprising? What works well in charts?| 颜色区分intuitive，一目了然，符合大众惯例认知；选择的故事唯独呈现的数据非常犀利，对比差异大，让人感到震撼;大部分图表能够相对直观的展示所要表达的故事 | 性骚扰话题和数据的选择以及呈现让人震撼且印象深刻；年龄图数字dashboard呈现引人注目；故事逻辑阐述选择的视角和数据比较有吸引力|  Content Cell  |  Content Cell  |
| Q3:  Is there anything you find confusing? What doesn't work well in charts?|图2-1 折线图的选择比较confusing，用户难以直观理解，直接用女性实际占比值堆叠条形图更直观;其他的图换个背景色，干净一点就好 |背景色显脏；图表大小不够统一；对于图表中想要表达的重点，可以通过一些方式进行强调；所有图表可以大标题描述事实，小标题阐述核心故事观点；图表2-1和其他图表比，在呈现上显得太空旷；图1-2 不知道logo的话很困惑，需要加色块图例和logo名称；图表2-2: 图表表意不够清晰，标题可以更informative，可以只展示女性占比的变化，从而更聚焦在核心观点，且可以用donut chart来呈现进度；图3-2加emoji凸显不同类别；图4-1：需要交代调研背景（800 女性音乐从业者），Report or Not标题要再具体一点： of witness & experience, 不同类别可以用渐变色表示； 图4-2:用词云组成年龄，使内容更丰富；图5:箭头间距小一点  ｜Content Cell  |  Content Cell  |
| Q4:  Do you think the color parttern design suit the topic well?| 颜色选择比较大众易懂，贴合女性主题，整体色调一致，对用户有较好的视觉教育；大片粉色的背景色显得比较脏，粉色元素太多，看着不intuitive，图表需要留白，显得更清晰  |  背景颜色显得比较脏，或许用桃色的底，白色的字，整体视觉效果会干净很多; 网页设计时，可以背景嵌入图片，图表做成亚克力半透明形式|  Content Cell  |  Content Cell  |
| Q5:  How engaged do you feel about the whole story? Will you respond to the call to action?| 故事整体是很具有煽动性的，角度和数字的选择激发了同理心和同情心，但call to action本身语言不够精炼，语句太长丧失了slogan的意义  | 故事煽动性不够强，call to action 部分可以凸显地做进悬浮框或tab，用户不需浏览全部内容就可以action；网站可以放女性歌手的背景音乐，网站最后展示source  |  Content Cell  |  Content Cell  |
| Q6:  Is there anything you would change or do differently?| 颜色背景板，白色留白；每个大part会增加一些增加氛围感的配图，丰富整个故事展现；增加一个有卓越贡献的女音乐家的名人堂图片，表达尽管行业状况对女性不友好，还是有很多女音乐家脱引而出，提升用户浏览情绪，从而更好的call to action|  同Q3  |  Content Cell  |  Content Cell  |          
